...
def create_cert_files(filename, list_participants, host_Name, event_Name):
...
#Enter event name
event_Name = "Student Challenge Python Expert"

# get participants
list_participants = get_participants(participants_file)

# process data
create_cert_files(certificate_file, list_participants, host_Name, event_Name)
